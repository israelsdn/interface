      ...
      <DefaultHeader>
        <div className="flex flex-row-reverse container space-x-7 space-x-reverse items-center">
          <div onMouseLeave={closeMenu}>
            <button
              onClick={openMenu}
              className="max-sm:mx-4 max-sm:w-12 max-sm:h-12 max-lg:w-14 max-lg:h-14 w-16 h-16 bg-purple-700 rounded-full items-center justify-center border-4 border-gray-700 "
            >
